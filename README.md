...
As an alternative to using the terminusdb-container script, you could use Docker Compose instead, using the example [docker-compose.yml](./docker-compose.yml)
